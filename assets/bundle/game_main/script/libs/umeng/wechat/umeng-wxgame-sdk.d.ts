/**
 * 友盟+ 微信小游戏/小程序 SDK 类型声明
 *
 * 接口参考友盟 U-MiniProgram SDK 官方文档：
 * https://developer.umeng.com/docs/147615/detail/184228
 *
 * 使用方式：
 * 1. 从友盟开发者中心下载微信小游戏 SDK（umeng-wxgame-sdk.js）
 * 2. 放入本目录（libs/umeng/wechat/）
 * 3. 在需要的地方 import 或 require 使用
 */

declare namespace umengWechat {
    interface InitOptions {
        ...
        /** 是否开启调试日志 */
        debug?: boolean;
        /** 是否使用Openid进行统计，此项为false时将使用友盟+uuid */
        useOpenid?: boolean;
        /** 上传用户的openid（useOpenid为true时必填） */
